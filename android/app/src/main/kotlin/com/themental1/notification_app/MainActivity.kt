                ...
                when (call.method) {
                    "setWebhookUrl" -> {
                        ...
                        if (url != null) {
                            ...
                            android.util.Log.d("MainActivity", "Webhook URL saved: $url")
                            result.success(null)
                        } else {
                    ...
                    "getWebhookUrl" -> {
                        val prefs = getSharedPreferences("notification_config", Context.MODE_PRIVATE)
                        val url = prefs.getString("webhook_url", "http://10.0.10.125:8082/log")
                        android.util.Log.d("MainActivity", "Webhook URL retrieved: $url")
                        result.success(url)
                    }
